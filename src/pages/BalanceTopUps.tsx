  ...
  return (
    <TutorialPage title={tLocal('balanceTopUpsTitle')}>
      <div className="space-y-8">
        ...
        <h2 className="text-xl font-semibold text-white">{tLocal('balanceTopUpsSubtitle')}</h2>
        ...
        <div className="space-y-6 bg-gray-800/50 rounded-lg p-6 border border-gray-700">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-700/30 rounded-lg p-4 my-4">
              <h3 className="text-lg font-semibold text-white mb-2">{tLocal('balanceTopUpsServicePayment')}</h3>
            ...
            <p className="text-gray-300">
              ...
              <Link to="/usdt" className="text-blue-400 hover:underline">
                USDT
              </Link>
            </p>
