    ...
    <TutorialPage title={globalT('clients')}>
      <div className="space-y-6">
        ...
        <div className="prose max-w-none dark:prose-invert">
          ...
          <Alert className="bg-blue-50/70 border-blue-200/50 dark:bg-secondary/20 dark:border-border mb-6">
            <div className="flex gap-2">
              <Shield className="h-5 w-5 text-primary dark:text-neonBlue" />
              <AlertDescription className="text-gray-700 dark:text-gray-300">
                <p className="font-medium">{t('bulkActions')}</p>
                <p className="mt-2">{t('bulkActionsDescription')}</p>
                <p className="mt-2">{t('messageTip')}</p>
              </AlertDescription>
            </div>
          </Alert>
        </div>
