    ...
    <TutorialPage title={t('mainStats')}>
      <div className="space-y-6">
        ...
        <div className="prose prose-invert max-w-none">
          <p className="text-gray-300 mb-6">{t('mainStatsDescription')}</p>
          ...
          <div className="mt-8">
            <img 
              src="https://i.ibb.co/CfdQKFp/Screenshot-2025-05-21-at-8-44-54-PM.png" 
                ...
                <div className="h-[250px]">
                  <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={data}>
                      ...
                      />
                      <Legend />
                      <Line type="monotone" dataKey="sales" stroke="#7E69AB" strokeWidth={2} activeDot={{ r: 6 }} />
            ...
            <Card className="bg-secondary/30 dark:bg-secondary/20 border-border">
              ...
              <CardContent>
                <div className="space-y-4">
                  {[1, 2, 3, 4, 5].map((item) => (
                    <div key={item} className="flex justify-between items-center py-2 border-b border-gray-700/50">
                      <div>
          ...
          <Card className="bg-secondary/30 dark:bg-secondary/20 border-border mb-8">
            ...
            <CardContent>
              <div className="space-y-4">
                {[1, 2, 3].map((item) => (
                  <div key={item} className="p-3 bg-gray-800/50 rounded-lg hover:bg-gray-800/70 transition-colors">
          ...
          <p className="text-gray-300">{t('newsInfo')}</p>
          
          <div className="mt-10 mb-8 p-4 bg-neonBlue/10 rounded-lg border border-neonBlue text-center">
            <p className="text-lg font-medium text-gray-300">{t('ourMotto')}</p>
          </div>
        </div>
      </div>
    </TutorialPage>
