      ...
      <div className="space-y-4">
        ...
        <div className="pl-4 space-y-3">
          <div className="bg-gray-50 dark:bg-[#111827] p-3 rounded border-l-4 border-blue-500">
            <span className="font-medium text-blue-700 dark:text-[#D6BCFA]">Боты</span> - радел где вы можете добавлять и отслеживать работу каждого бота 
          </div>
          <div className="bg-gray-50 dark:bg-[#111827] p-3 rounded border-l-4 border-green-500">
            <span className="font-medium text-green-700 dark:text-green-400">Сотрудники</span> - раздед для регистрации учетных записей вашей команды
          </div>
          <div className="bg-gray-50 dark:bg-[#111827] p-3 rounded border-l-4 border-purple-500">
            <span className="font-medium text-purple-700 dark:text-purple-400">Клиенты</span> - список ваших клиентов, любой человек который когда либо писал в ваш бот
          </div>
          <div className="bg-gray-50 dark:bg-[#111827] p-3 rounded border-l-4 border-orange-500">
            <span className="font-medium text-orange-700 dark:text-orange-400">Маркетинг</span> - различные промо акции для улчшения ваших продаж
          </div>
