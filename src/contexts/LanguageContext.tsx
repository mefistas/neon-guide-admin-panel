...
const translations: Translations = {
  ...
  ru: {
    ...
    quickStartPoint3Note6: 'Описание товара так же будет видно в боте поэтому напиши пару слов о своем VHQ мефедроне',
    ...
    quickStartPoint4Note8: 'Все остальное в разделе ВИДЫ ТОВАРОВ пока можно скипать, если что то непонятно будет посмотри потом более детальный гайд',
    ...
    quickStartPoint8Note8: 'Ставим галочку напротив нашего магазина, вставляем токен который нам дал BotFather, выбираем тип бота (БОТ-ПРОДАВЕЦ) за остальных можешь почитать в полной аннотации. Рекомендую защитить капчей просто поставив галочку напротив этого пункта. Нажимаем сохранить. Теперь в разделе ботов мы можем видеть наш новый бот и ОБЯЗАТЕЛЬНО НАЖИМАЕМ ЗЕЛЕНУЮ КНОПКУ ЗАПУСКА которая находится в конце всей информации о вашем боте справа, иначе бот не начнет свою работу. Переходим в тг открываем бот и смотрим как он выглядит, для Кастомизации бота изучи раздел КАСТОМНЫЙ БОТ, а пока все что осталось это добавить адреса и подключить нужные способы оплаты',
    ...
    quickStartPoint10Note8: 'ВАЖНО: если ты выбрал оплату в USDT то что бы она отображалась в боте пройди в меню ДОПОЛНИТЕЛЬНО - USDT TRC20 АДРЕСА - ДОБАВИТЬ USDT-TRC-20 АДРЕС - выбери свой магазин, а так же укажи свой usdt trc20 кошелек, все заказы оплаченные таким образом будут приходить непосредственно на твой кошель',
