...
const translations: Translations = {
  ...
  ru: {
    ...
    // Quick Start page content
    quickStartDescription: 'Это руководство по быстрому старту поможет тебе настроить и сконфигурировать админ-панель всего за 11 шагов. Следуйте этим инструкциям, чтобы быстро запустить свои продажи.На главной странице есть графики - в них собраны статистические данные работы вашего магазина/n В вверхней части меню - есть куча разных разделов - основные - это боты - где создаете ботов,сотрудники - где создаете сотрудников краткое описание какое-то, клиенты - это список ваших клиентов кто когда либо писал боту, раздел Маркетинг - тут разные промо акции ивсе такое и раздел СКЛАД - основной раздел где можно настроить города, районы, курьеры, товары и адреса  ',
