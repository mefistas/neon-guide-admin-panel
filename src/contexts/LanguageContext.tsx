...
const translations: Translations = {
  ...
  ru: {
    ...
    quickStartPoint4Note1: 'Данный пункт является не обязательным но необходим в том случае если в вашем магазине существует достаточно много товаров с разной фасовкой например: \n Группа товаров лимоны и дальше виды товаров 1 кг 5кг, ящик,  фура . Если же вам нужен этот раздел переходим снова в СКЛАД - ВИДЫ ТОВАРОВ',
    ...
    quickStartPoint5Note7: 'Если вы заполните все эти поля - тогда на странице Покупок будет указана дополнительная статистика по вашей прибыли расчитанная на основе этих данных',
    quickStartPoint5Note8: '',
