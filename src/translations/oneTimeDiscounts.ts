...
const oneTimeDiscountsTranslations: TranslationType = {
  ...
  ru: {
    ...
    speedTip: "Однако если ты любишь скорость, а твой клиент выклянчивает скидочку, намного проще изменить его баланс напрямую в карточке клиента, для этого советую ознакомиться с разделом Клиенты",
