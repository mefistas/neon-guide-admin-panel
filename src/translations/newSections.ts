...
const translations = {
  en: {
    ...
    preordersAdditionalSettings: "All other settings of the \"Product Type\" are similar to a regular product.",
  ...
  ru: {
    ...
    preordersAdditionalSettings: "Все остальные настройки \"Вида товара\" аналогичны обычному товару.",
