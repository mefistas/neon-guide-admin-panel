...
const preordersTranslations = {
  en: {
    ...
    preordersOtherSettings: "All other settings of the \"Product Type\" are similar to a regular product.",
    ...
    preordersLearnMore: "To learn more about employee settings for preorders, please check the",
    workers: "WORKERS",
    section: "section"
  },
  ru: {
    ...
    preordersOtherSettings: "Все остальные настройки \"Вида товара\" аналогичны обычному товару.",
...
export default preordersTranslations;
