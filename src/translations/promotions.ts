...
const promotionsTranslations: TranslationType = {
  en: {
  ...
  ru: {
    ...
    oneTimeDepositDesc: "Обратите внимание что при использовании акции по сумме депозита за раз нужно поставить 0 в разделах касающихся отзывов и выбрать товары которые будут участвовать в самой акции. В данном случае мы видим что любой клиент совершивший разовый депозит 100 в валюте магазина и более в период с 19.05 по 30.05 получит 20 бонусов на свой баланс бота.",
    ...
    deleteUnusedDiscounts: "Галочка - \"Удалить все неиспользованные скидки после окончания акции\" Если ее установить, то все разовые скидки, которые клиенты не успели использовать до окончания акции сгорят.",
...
export default promotionsTranslations;
